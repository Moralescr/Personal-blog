...
jQuery.fn.stringToSlug = function(options) {
    var defaults = { setEvents: 'keyup keydown blur', getPut: '#permalink', space: '-', prefix: '', suffix: '', replace: '', AND: 'and', callback: false, };
    ...
    jQuery(this).bind(defaults.setEvents, function() {
        ...
        if (defaults.callback != false) { defaults.callback(stringToSlug) }
        return this
    });
    return this
};